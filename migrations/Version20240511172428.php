 ...
 */
final class Version20240511172428 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE destination_avion (destination_id INT NOT NULL, avion_id INT NOT NULL, INDEX IDX_72303C8B816C6140 (destination_id), INDEX IDX_72303C8B80BBB841 (avion_id), PRIMARY KEY(destination_id, avion_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
